...
3) Create a manifest file for a `CertificateSigningRequest` object, with encoded `CSR` included as a request
```
cat csr.yaml
...
spec:
  ...
  request: |
    ...
    
...
5) Now you (and all other admins on K8S cluster) can see that `CSR`:
```
# See CSR
kubectl get csr
```

6) Now you (and all other admins on K8S cluster) can approve that `CSR`:
```
# Approve specific CSR
kubectl certificate approve jane 
```

7) Get `certificate` for signed `CSR` and provide to the new admin:
```
